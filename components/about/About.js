...
const About = () => {
    ...
    return (
        <div id='about' className='w-full min-h-[700px] relative'>
            <div className="h-24 w-full"></div>
            <div className='w-2/3 h-full mx-auto'>
                <header>
                    <h1
                        ref={ref}
                        className={`font-rubik font-bold text-2xl text-primary text-center uppercase lg:text-3xl xl:text-4xl`}
                    >
                ...
                <section className='font-ibm text-lg text-black tracking-wide mt-8'>
                    <aside className='float-left pr-4 pb-2'>
                        <div className='w-fit h-fit rounded-full border-4 border-primary'>
                            <figure className="w-32 h-32 rounded-full overflow-hidden border-2 border-white relative pointer-events-none lg:w-36 lg:h-36 xl:w-44 xl:h-44">
                    ...
                    <br />
                    {/* <p>I'm a software engineer intrerested in building things on the web.</p>
                    <br /> */}
                ...
                <br />
                <section className='font-ibm text-lg text-black tracking-wide'>
                    <h2 className='text-primary text-2xl font-bold font-rubik'>Front-end Developer</h2>
                    <br />
                ...
                <br />
                <section className='font-ibm text-lg text-black tracking-wide'>
                    <h3 className='text-primary text-xl font-bold font-rubik'>Skills</h3>
                    <br />
                ...
                <br />
                <section className='font-ibm text-lg text-black tracking-wide'>
                    <h2 className='text-primary text-2xl font-bold font-rubik'>Back-end Developer</h2>
                    <br />
