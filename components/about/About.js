    ...
    <div id="about" className="w-full min-h-[700px] relative p-4">
      ...
      <div className="w-full h-full mx-auto max-w-lg sm:max-w-4xl">
        ...
        <section className="font-ibm text-sm text-black tracking-wide mt-10 flex flex-col-reverse sm:flex-row sm:gap-4 sm:text-base md:text-lg lg:text-xl">
          <aside className="mt-8 sm:mt-0">
            <div className="w-fit h-fit mx-auto">
              <figure className="overflow-hidden rounded-md relative pointer-events-none w-[166px] h-[222px] md:w-[200px] md:h-[266px] lg:w-[250px] lg:h-[333px]">
                <Image
                  priority
                  src="https://ucarecdn.com/ea43bcb7-73ba-4c2f-a7b5-12e3cd2641bc/vk.jpeg"
                  alt="me"
                  layout="fill"
                />
              </figure>
          ...
          <div>
            <p>
              I&apos;m a Software Engineer specializing in developing
              exceptional web experiences. I create successful websites that are
              fast, easy to use, and built with best practices.
            </p>
            <br />
            <p>
              My main experience is in full stack development but I&apos;m more
              passionate towards front-end development and designing. Given that
              producing a modern website requires the combination of design,
              server technology, and the layer that users interacts with, I
              believe having experience in both design and development allows
              for making the most optimal user experiences.
            </p>
            <br />
            <p>
              For me, look and feel is the most important thing when using web.
              That&apos;s why I give more focus towards front-end development
              nowadays.
            </p>
          </div>
        </section>
        ...
        <div className="mt-4 sm:mt-8">
          <ul className="list-none w-fit mx-auto flex items-center text-white justify-center gap-7">
            <li className="p-2 bg-gray rounded-full transition-colors hover:bg-gray-light">
              <a
                href="https://github.com/vyshak-sukumaran"
                target="_blank"
            ...
            <li className="p-2 bg-gray rounded-full transition-colors hover:bg-gray-light">
              <a
                href="https://www.linkedin.com/in/vyshak-t-69b6671b8"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <li className="p-2 bg-gray rounded-full transition-colors hover:bg-gray-light">
              <a
                href="https://mobile.twitter.com/VyshakS2000"
                target="_blank"
                rel="noopener noreferrer"
              >
