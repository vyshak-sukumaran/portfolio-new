      ...
      <div className="absolute w-2/3 h-[28rem] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex">
        ...
        <div className="basis-1/2">
          <form className='flex flex-col gap-2' onSubmit={handleSubmit}>
            <input
              className='w-full p-4 border-[3px] border-secondary rounded-md active:outline-none focus-within:outline-none'
              type="text"
              placeholder='Name'
            />
            <input
            ...
            />
            <textarea
              className='w-full p-4 border-[3px] border-secondary rounded-md focus-within:outline-none resize-none'
